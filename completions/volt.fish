...
complete -f -c volt -n "__fish_seen_subcommand_from get; __fish_prev_arg_in -u" -s l -d "use all plugins in current profile as targets"
complete -f -c volt -n "__fish_seen_subcommand_from get" -s u -a "(__volt_all_plugs)" -d "upgrade plugins"
...
complete -f -c volt -n "__fish_seen_subcommand_from enable" -a "(__volt_get_plugs (__volt_get_profile) not)"
complete -f -c volt -n "__fish_seen_subcommand_from disable" -a "(__volt_get_plugs (__volt_get_profile) this)"
